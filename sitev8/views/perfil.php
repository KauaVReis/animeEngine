...
// auth.php já incluído pelo Front Controller via header.php
...
if ($username_param) {
    ...
    // Ver próprio perfil
    if (!estaLogado()) {
        header('Location: ?page=login&redirect=perfil');
        exit;
    }
...
?>
    ...
    <div class="profile-container">
            ...
            <div class="profile-hero"
                ...
                <div class="profile-hero-content">
                    ...
                    <div class="profile-hero-actions">
                        <?php if ($viewing_own): ?>
                            <a href="?page=editar_perfil" class="btn btn-secondary btn-sm" style="border-radius: 50px;">
        ...
        <div class="profile-section comments-section">
            ...
            <?php else: ?>
                <p class="login-prompt"><a href="?page=login">Faça login</a> para comentar</p>
            <?php endif; ?>
